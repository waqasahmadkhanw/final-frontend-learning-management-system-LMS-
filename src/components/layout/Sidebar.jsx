...
//         {user.role === "student" && (
//           <>
//             <Nav.Link className="text-white" onClick={() => navigate("/my-courses")}>
//               My Courses
//             </Nav.Link>
//           </>
//         )}
...
//           <>
//             <Nav.Link className="text-white" onClick={() => navigate("/create-course")}>
//               Create Course
//             </Nav.Link>
//             <Nav.Link className="text-white" onClick={() => navigate("/courses")}>
//               Manage Courses
//             </Nav.Link>
//           </>
//         )}
...
//               Analytics
//             </Nav.Link>
//             <Nav.Link className="text-white" onClick={() => navigate("/admin/users")}>
//               Manage Users
//             </Nav.Link>
//           </>
//         )}
